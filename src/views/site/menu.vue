        ...
        <template v-slot:activator>
          <v-list-item-content>
            <v-list-item-title class="d-flex align-center">
              ...
              <v-icon color="error" right v-if="newCheck(new Date(item.createdAt), 'days', 1)">mdi-creation</v-icon>
            </v-list-item-title>
        ...
        >
          <v-list-item-content>
            <v-list-item-title :class="$store.state.editable ? 'pl-4':''" class="d-flex align-center">
              ...
              <v-icon color="error" right v-if="newCheck(new Date(subItem.createdAt), 'days', 1)">mdi-creation</v-icon>
            </v-list-item-title>
            <v-list-item-subtitle v-if="$store.state.editable">
